...
SUMMARY: str = (
    "tempest-core: the renderer-agnostic UI core shared across the tempest stack "
    "— a typed, frozen Pydantic widget/style IR, a pure build/diff reconciler, the "
    "Material 3 design-token + Chakra-style variant system (resolve_variant and "
    "its field/selection/slider/surface/badge/alert siblings), and coalesced App "
    "state. No platform-coupled code; the only hard dependency is pydantic."
)
